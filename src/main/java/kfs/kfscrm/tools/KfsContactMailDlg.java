 ...
 * @author pavedrim
 */
public class KfsContactMailDlg extends Window {
    ...
    private KfsContactMail contactMail;
    private KfsRefresh refresh;

    public KfsContactMailDlg(UI ui, KfsI18n i18n, CrmService crmService, String userName) {
        this(ui, i18n, crmService, userName, "KfsContactMailDlg", "KfsContactMailDlg");
    }

    public KfsContactMailDlg(UI ui, KfsI18n i18n, CrmService crmService, String userName, String dlgName,
            String i18nPrefix) {
        this.ui = ui;
        this.i18n = i18n;
        ...
        fg = new MFieldGroup(i18n, dlgName, null, KfsContactMail.class);
    ...
    public CharSequence validate(String prefix, KfsContactMail contact) {
        fg.setItems(contact);
    ...
    public void save(Button.ClickEvent event) {
        ...
        crmService.mailSave(contactMail, userName);
    ...
    public void show(String text, KfsContactMail contact, KfsRefresh refresh) {
