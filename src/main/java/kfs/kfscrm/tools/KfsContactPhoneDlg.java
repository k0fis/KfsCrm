 ...
 * @author pavedrim
 */
public class KfsContactPhoneDlg extends Window {
    ...
    private KfsContactPhone contactPhone;
    private KfsRefresh refresh;

    public KfsContactPhoneDlg(UI ui, KfsI18n i18n, CrmService crmService, String userName) {
        this(ui, i18n, crmService, userName, "KfsContactPhoneDlg", "KfsContactPhoneDlg");
    }

    public KfsContactPhoneDlg(UI ui, KfsI18n i18n, CrmService crmService, String userName, String dlgName,
            String i18nPrefix) {
        this.ui = ui;
        this.i18n = i18n;
        ...
        fg = new MFieldGroup(i18n, dlgName, null, KfsContactPhone.class);
    ...
    public CharSequence validate(String prefix, KfsContactPhone contact) {
        fg.setItems(contact);
    ...
    public void save(Button.ClickEvent event) {
        ...
        crmService.phoneSave(contactPhone, userName);
    ...
    public void show(String text, KfsContactPhone contact, KfsRefresh refresh) {
